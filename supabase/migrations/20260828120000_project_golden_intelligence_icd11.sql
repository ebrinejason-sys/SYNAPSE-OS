-- PROJECT GOLDEN: terminology cache, intelligence audit, adapter registry.
-- Reasoning tables already exist in some environments; create if missing.
-- Additive. Does not change pharmacy POS contracts.
