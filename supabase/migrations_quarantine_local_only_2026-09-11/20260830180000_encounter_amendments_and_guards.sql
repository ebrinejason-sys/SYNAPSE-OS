...
-- Block silent edits to signed encounter clinical fields
...
-- Authoritative amendment path (records trail + applies change)
...
-- P0-005: Block production hospital seed reset
...
-- Capabilities for encounter amend + billing read
