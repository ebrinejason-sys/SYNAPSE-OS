...
export const UCG_MALARIA_GUIDELINE: GuidelineSource = {
  id: "guideline.ucg.malaria.2023",
  name: "Malaria diagnosis and treatment (adapted teaching set)",
  organization: "Uganda Clinical Guidelines (adapted)",
  version: "teaching-2026.1",
  publishedOn: "2026-01-15",
  url: null,
}

export const MALARIA_PATHWAY: ClinicalPathwayDefinition = {
  id: "pathway.malaria",
  name: "Suspected malaria",
  specialty: "outpatient / emergency",
  version: "1.0.0",
  source: UCG_MALARIA_GUIDELINE,
  sourceVersion: UCG_MALARIA_GUIDELINE.version,
  effectiveDate: "2026-08-01",
  reviewDate: "2027-08-01",
  status: "active",
  countryPack: "UG",
  author: "SYNAPSE clinical content (demo)",
  reviewer: "clinician-in-control",
  triggers: ["fever", "chills", "headache", "endemic_area", "suspected_malaria"],
  steps: [
    {
      id: "assess",
      sequence: 1,
      ...
      required: true,
      actionKind: "observation",
      instruction: "Record fever history, danger signs, pregnancy status. Clinician confirms pathway start.",
      recommendedAction: "Activate malaria pathway after clinician confirmation",
    },
    {
      id: "investigate",
      sequence: 2,
      ...
      required: true,
      actionKind: "lab_order",
      instruction: "Order malaria antigen or microscopy. Do not delay severe-malaria care for the result.",
      recommendedAction: "Order malaria Pf antigen",
      orderSet: [{ loincCode: "58413-6", testName: "Malaria Pf antigen", urgency: "URGENT" }],
    },
    {
      id: "interpret",
      sequence: 3,
      ...
      required: true,
      actionKind: "escalation",
      instruction: "Positive antigen with danger signs is severe malaria until a clinician says otherwise.",
      recommendedAction: "Review antigen result and danger signs",
    },
    {
      id: "treat",
      sequence: 4,
      ...
      required: true,
      actionKind: "medication",
      instruction: "Uncomplicated: ACT. Severe: parenteral artesunate. Clinician must prescribe.",
      recommendedAction: "Prescribe artemether/lumefantrine after clinician confirmation",
      orderSet: [{ medicationDisplay: "Artemether/lumefantrine 80/480 mg", urgency: "STAT" }],
    },
    {
      id: "dispense",
      sequence: 5,
      ...
      actionKind: "medication",
      instruction: "Prescribing and dispensing remain separate permissions.",
      recommendedAction: "Pharmacist verifies and dispenses the ACT",
    },
    {
      id: "monitor",
      sequence: 6,
      ...
      required: true,
      actionKind: "monitoring",
      instruction: "Repeat observations. Counsel on completing the ACT course.",
      recommendedAction: "Repeat vitals and counsel on adherence",
    },
    {
      id: "outcome",
      sequence: 7,
      ...
      required: true,
      actionKind: "outcome",
      instruction: "Record clinical outcome and freeze the pathway version used.",
      recommendedAction: "Record pathway outcome",
    },
  ],
}

export const UCG_DKA_GUIDELINE: GuidelineSource = {
  id: "guideline.ucg.dka.2023",
  name: "Diabetic ketoacidosis (adapted teaching set)",
  organization: "Uganda Clinical Guidelines (adapted)",
  version: "teaching-2026.1",
  publishedOn: "2026-01-15",
  url: null,
...
export const DKA_PATHWAY: ClinicalPathwayDefinition = {
  id: "pathway.dka",
  name: "Diabetic ketoacidosis",
  specialty: "emergency / internal medicine",
  version: "1.0.0",
  source: UCG_DKA_GUIDELINE,
  sourceVersion: UCG_DKA_GUIDELINE.version,
  effectiveDate: "2026-08-01",
  reviewDate: "2027-08-01",
  status: "active",
  countryPack: "UG",
  author: "SYNAPSE clinical content (demo)",
  reviewer: "clinician-in-control",
  triggers: ["hyperglycaemia", "ketones", "acidosis", "polyuria", "kussmaul"],
  steps: [
    {
      id: "assess",
      sequence: 1,
      ...
      required: true,
      actionKind: "observation",
      instruction: "Airway, fluid status, GCS. Clinician confirms DKA pathway.",
      recommendedAction: "Activate DKA pathway after clinician confirmation",
    },
    {
      id: "investigate",
      sequence: 2,
      ...
      required: true,
      actionKind: "lab_order",
      instruction: "Glucose, ketones/blood gas, electrolytes. Do not wait to start fluids if the clinician has diagnosed DKA.",
      recommendedAction: "Order STAT glucose and electrolytes",
      orderSet: [
        { loincCode: "2345-7", testName: "Glucose", urgency: "STAT" },
        { loincCode: "2823-3", testName: "Potassium", urgency: "STAT" },
      ],
    },
    {
      id: "interpret",
      ...
      required: true,
      actionKind: "escalation",
      instruction: "Critical potassium or glucose requires acknowledgement. AI may not treat.",
      recommendedAction: "Acknowledge critical chemistry and review insulin/fluids",
    },
    {
      id: "treat",
      sequence: 4,
      ...
      required: true,
      actionKind: "medication",
      instruction: "Fluids then insulin per local protocol. Clinician prescribes.",
      recommendedAction: "Prescribe IV fluids and insulin per local DKA protocol",
      orderSet: [{ medicationDisplay: "Soluble insulin IV protocol", urgency: "STAT" }],
    },
    {
      id: "dispense",
      sequence: 5,
      name: "Pharmacy / ward stock",
      required: true,
      actionKind: "medication",
      instruction: "Ward stock still requires a verified medication request.",
      recommendedAction: "Verify insulin/fluids against the medication request",
    },
    {
      id: "monitor",
      sequence: 6,
      ...
      required: true,
      actionKind: "monitoring",
      instruction: "Repeat glucose and potassium. Watch for cerebral oedema in children.",
      recommendedAction: "Repeat glucose and potassium on the protocol clock",
    },
    {
      id: "outcome",
      sequence: 7,
      ...
      required: true,
      actionKind: "outcome",
      instruction: "Record resolution or escalation.",
      recommendedAction: "Record pathway outcome",
    },
  ],
}

export const UCG_PNEUMONIA_GUIDELINE: GuidelineSource = {
  id: "guideline.ucg.pneumonia.2023",
  name: "Community-acquired pneumonia (adapted teaching set)",
  organization: "Uganda Clinical Guidelines (adapted)",
  version: "teaching-2026.1",
  publishedOn: "2026-01-15",
  url: null,
...
export const PNEUMONIA_PATHWAY: ClinicalPathwayDefinition = {
  id: "pathway.pneumonia",
  name: "Community-acquired pneumonia",
  specialty: "outpatient / inpatient medicine",
  version: "1.0.0",
  source: UCG_PNEUMONIA_GUIDELINE,
  sourceVersion: UCG_PNEUMONIA_GUIDELINE.version,
  effectiveDate: "2026-08-01",
  reviewDate: "2027-08-01",
  status: "active",
  countryPack: "UG",
  author: "SYNAPSE clinical content (demo)",
  reviewer: "clinician-in-control",
  triggers: ["cough", "fever", "tachypnoea", "hypoxia", "chest_findings"],
  steps: [
    {
      id: "assess",
      sequence: 1,
      ...
      required: true,
      actionKind: "observation",
      instruction: "RR, SpO2, danger signs. Clinician confirms pneumonia pathway.",
      recommendedAction: "Activate pneumonia pathway after clinician confirmation",
    },
    {
      id: "investigate",
      sequence: 2,
      ...
      required: true,
      actionKind: "lab_order",
      instruction: "CBC. CXR when available. Do not delay oxygen for imaging.",
      recommendedAction: "Order CBC",
      orderSet: [{ loincCode: "6690-2", testName: "WBC", urgency: "URGENT" }],
    },
    {
      id: "interpret",
      sequence: 3,
      ...
      required: true,
      actionKind: "escalation",
      instruction: "Hypoxia or danger signs escalate. AI may not start oxygen or antibiotics.",
      recommendedAction: "Review SpO2 and danger signs",
    },
    {
      id: "treat",
      sequence: 4,
      ...
      required: true,
      actionKind: "medication",
      instruction: "Empiric antibiotic per UCG. Clinician prescribes. Oxygen if indicated.",
      recommendedAction: "Prescribe empiric antibiotic after clinician confirmation",
      orderSet: [{ medicationDisplay: "Amoxicillin 500 mg PO", urgency: "STAT" }],
    },
    {
      id: "dispense",
      sequence: 5,
      ...
      actionKind: "medication",
      instruction: "Prescribing and dispensing remain separate permissions.",
      recommendedAction: "Pharmacist verifies and dispenses the antibiotic",
    },
    {
      id: "monitor",
      sequence: 6,
      ...
      required: true,
      actionKind: "monitoring",
      instruction: "Repeat RR and SpO2. Safety-net for deterioration.",
      recommendedAction: "Repeat vitals within 1 hour if admitted",
    },
    {
      id: "outcome",
      sequence: 7,
      ...
      required: true,
      actionKind: "outcome",
      instruction: "Record clinical outcome.",
      recommendedAction: "Record pathway outcome",
    },
  ],
}

export const PATHWAY_CATALOG: ClinicalPathwayDefinition[] = [
  SEPSIS_PATHWAY,
  MALARIA_PATHWAY,
  DKA_PATHWAY,
  PNEUMONIA_PATHWAY,
