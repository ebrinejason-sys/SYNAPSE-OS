...
export const PLATFORM_CAPABILITIES: CapabilityRecord[] = [
  ...
  cap({
    ...
    summary: "Phase 0–1 DHIS2 aggregate export: privacy gate, simulation adapter, job queue, platform monitor.",
    owner: "public-health",
    publicClaim: "Governed aggregate export to DHIS2 (simulation-first).",
    limitation: "No live MoH push by default. Tracker/events and cross-facility surveillance are Phase 2+.",
    environments: ["local", "staging"],
    tests: ["packages/interop/src/dhis2/privacy-export.test.ts", "packages/interop/src/adapters/dhis2.test.ts"],
    telemetry: "partial",
  }),
  cap({
    id: "synapse-edge",
...
export const INTEGRATIONS: IntegrationRecord[] = [
  ...
  },
  {
    ...
    standard: "DHIS2",
    status: "development",
    summary: "Outbound aggregate DataValueSet pipeline with simulation adapter and privacy gate.",
    limitation: "Default mode is simulation. Live national export requires DHIS2_MODE=live + operator proof.",
  },
  {
    id: "alis",
    name: "ALIS",
