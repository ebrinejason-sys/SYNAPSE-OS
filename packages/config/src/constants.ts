...
export const UGANDA_DISTRICTS = [
  ...
  'Buvuma','Buyende','Dokolo','Fort Portal','Fort Portal City','Gomba','Gulu','Gulu City',
  'Hoima','Ibanda','Iganga','Isingiro','Jinja','Jinja City','Kaabong',
  ...
  'Luwero','Lwengo','Lyantonde','Madi-Okollo','Manafwa','Maracha',
  'Masaka','Masindi','Mayuge','Mbale','Mbarara','Mbarara City','Mitooma',
