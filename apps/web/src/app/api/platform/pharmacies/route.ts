...
export async function POST(request: Request) {
  ...
  // Create pharmacy_onboarding record — invite_token generated by DB default, admin info stored
  // for pre-filling the invite form. Profile is created when the admin redeems the invite.
      ...
      .upsert(
        {
          ...
          admin_name: body.contactName || null,
          current_step: 0,
          enrolled_by: actorId,
